...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="p-2 space-y-2 rounded mr-2 cursor-pointer border border-slate-200 bg-white hover:bg-slate-100 focus:bg-slate-100  dark:focus:bg-slate-800 hover:text-slate-900 dark:border-slate-800 dark:bg-slate-950 dark:hover:bg-slate-800 dark:hover:text-slate-50 md:hidden block" onClick={() => {
        setishidden(false)
        setIsScrolled(true)
      }}>
    ...
    <OutsideClickHandler onOutsideClick={handleOutsideClick} ishidden={ishidden}>
