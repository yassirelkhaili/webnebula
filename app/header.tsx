...
export default function Header() {
  ...
  return (
    <header
      className={`flex max-w-full fixed bg-transparent w-screen z-50 h-20 backdrop-blur-[10px] backdrop-saturate-[180%] shadow-md ease-in-out transition duration-500 ${
