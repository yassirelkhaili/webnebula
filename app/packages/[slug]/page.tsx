...
import { checkoutContent, checkoutProps, deliveryTimeProps} from "@/app/constants/checkout";
...
const Booking = ({ params }: { params: { slug: string } }) => {
  return (
    ...
    <div>
      ...
      <Table>
  <TableCaption>This list highlights the key features of the packages.</TableCaption>
  <TableHeader>
    <TableRow>
      <TableHead className="w-[100px]">Package</TableHead>
      <TableHead>ESSENTIAL WEB PRESENCE PACKAGE</TableHead>
    </TableRow>
  </TableHeader>
  <TableBody>
