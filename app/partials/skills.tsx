...
return (
    ...
    <div>
    <h1 id="Skills" className="text-3xl font-lato font-bold dark:text-slate-50 text-dark p-3 border-b-[3px] border-b-logo-100 dark:border-b-logo-900 w-fit">{skillsTitle}</h1>
    </div>
    <div className="grid grid-cols-4 gap-4 container">
    {skillsContent.map((item : Content)=> (
        <Card className="mt-8"> 
        <CardHeader className="flex flex-col gap-2 pt-[1.5rem]">
